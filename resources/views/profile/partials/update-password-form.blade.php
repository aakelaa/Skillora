<section class="card-padded">
    <header>
        <h2 class="text-lg font-bold text-heading">{{ __('Update Password') }}</h2>
        <p class="mt-1 text-sm text-paragraph">Ensure your account is using a long, random password to stay secure.</p>
    </header>
